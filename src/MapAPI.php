...
class MapAPI extends Control
{
    ...
    /**
     * Sets geocode data for location focus. If only one parameter is supported, search will be performed using given parameter.
     * If both parameters are present, firstly search by location name is performed, then by coordinates if location name search returns 0 results.
     *
     ...
     * @return $this
     */
    public function isUseSearch(bool $useSearch = true)
    {
     ...
     * @return bool
     */
    public function getIsUseSearch()
    {
